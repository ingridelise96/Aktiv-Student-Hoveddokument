...
\hl{Nytt avsnitt}
Etter at undersøkelsen ble gjennomført og gruppen hadde fått 15 svar, fikk gruppen en god ide om hvilke ord og fraser som kunne brukes og de som ikke kunne brukes. F.eks 60\% av deltakerene syntes at \say{Nær meg} var det mest effektive frasen å bruke for å finne ting i nerheten, mens 0\% syntes at \say{Organisasjonsnummer} var et effektivt ord å bruke. Når det kom til kategorier var det noen som det ble klart at burde endres. \say{Kultur og rekreasjon} var forslaget som var mest forvirrende, 55,6\% synes at den var uforståelig eller dårlig beskrevet. Videre ville gruppen vite om det var ting som brukerene syntes det var viktig å vite om nærområde rundt organisasjonene og det to tingen brukerene synes var viktigst var \say{Transporttilbud} med 80\% og \say{om det finnes mennesker i nærområdet med felles interesser som meg} med 73\%.
...
Det måtte være et simpelt design fylt med ting som var viktig å ha med, ikke ha med masse fine greier som bare ser fint uten å være nødvendig for at siden skal fungere. Det måtte også gjøres plass til ting som brukerene synes var viktig eller kunne fungere, som f.eks \say{Nær meg} funksjonen og gjøre plass til Google Maps.
