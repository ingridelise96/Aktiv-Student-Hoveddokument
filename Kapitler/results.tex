...
Boken {\em Successful User Experience: Strategies and Roadmaps} nevner kreativitet og innovasjon som viktige verktøy når det kom til å løse en brukers problem: \say{In order to be creative and produce innovative solutions to users’ problems, UX professionals need to think differently: out of the box.} (s. 29) \cite{SUCCESSFUL-UX:18}. Forfatteren av boken {\em Interactive Design : An Introduction to the Theory and Application of User-centered Design} skrev om hvordan underholdende og morsom funksjonalitet kunne engasjere brukeren: \say{Users are engaged through entertainment. the more pleasure a user gets from interacting with what you’ve designed, the more engaged they will be and the more likely they will be to return.[...] Game play can be incorporated into an application to make normally tedious tasks fun like filling out forms. Good design itself can be pleasurable.} (s. 123). \cite{INTERACTIVE-DESIGN:19}
